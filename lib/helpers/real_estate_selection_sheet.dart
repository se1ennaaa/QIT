...
class RealEstateSelectionSheet extends HookConsumerWidget {
  const RealEstateSelectionSheet(
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final categories = ref.watch(categoryListProvider(CategoryType.property));
