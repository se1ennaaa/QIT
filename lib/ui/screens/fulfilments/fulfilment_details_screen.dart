...
class FulfilmentDetailsScreen extends HookConsumerWidget {
  const FulfilmentDetailsScreen(
    this.id, {
    super.key,
  ...
  final int id;
  final FulfilmentParamsModel? listInitialParams;
  final bool canEdit;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final fulfilmentDetailsState = ref.watch(fulfilmentDetailsProvider(id));
      ...
      child: Scaffold(
        body: ListView(
          ...
          children: [
            CustomAppBar(
              title: 'Фулфилмент',
              isFavorite: fulfilmentDetailsState.maybeWhen(
                orElse: () => false,
              ...
              onHeartTap: () {
                ...
                ref.read(toggleFavoriteProvider(id, FavoriteType.fulfillment));
                ref
                    .read(fulfilmentDetailsProvider(id).notifier)
                    .toogleFavorite();
                if (listInitialParams != null) {
                  ref
                      .read(fulfilmentListProvider(params: listInitialParams)
                          .notifier)
                      .toogleFavorite(id);
                }
              },
            ),
            fulfilmentDetailsState.when(
              data: (data) => Column(
                children: [
                  Gap(27),
        ...
        floatingActionButton: fulfilmentDetailsState.maybeWhen(
          orElse: () => null,
          data: (data) {
            ...
            return Padding(
              ...
              child: EditAdButtonScreen(
                onTap: () async {
                  showAddFulfilmentSheet(context, id: id);
                },
                height: 49,
                borderRadius: 15,
                titleFontSize: 14,
