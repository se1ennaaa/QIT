...
class FulfilmentsScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final initialParams =
        FulfilmentParamsModel(isMy: isMy, isFavorites: isFavourite);
    final fulfilmentListState =
        ref.watch(fulfilmentListProvider(params: initialParams));
    ...
    scrollController.addListener(
      () {
        if (scrollController.position.pixels >=
          ...
          ref
              .read(fulfilmentListProvider(params: initialParams).notifier)
              .loadMore();
        }
            ...
            slivers: [
              SliverToBoxAdapter(
                child: AppBarWithTextField(
                  onChanged: (value) {
                    ref
                        .read(fulfilmentListProvider(params: initialParams)
                            .notifier)
                        .filter(
                          FulfilmentParamsModel(
                            searchText: value,
                          ),
                        );
                  },
                ...
                data: (data) {
                  ...
                  return SliverToBoxAdapter(
                    child: FulfilmentsSection(
                      canEdit: isMy,
                      fulfilmentList: data,
                      paginationLoading: fulfilmentListState.list.isLoading,
                      onFavoriteTap: (id) {
