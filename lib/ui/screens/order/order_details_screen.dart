...
class OrderDetailsScreen extends HookConsumerWidget {
  ...
  final int id;
  final OrderParamsModel? listInitialParams;
  final bool canEdit;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final orderDetailsState = ref.watch(orderDetailsProvider(id));
      ...
      child: Scaffold(
        body: ListView(
          ...
          children: [
            CustomAppBar(
              title: 'Заказы',
              isFavorite: orderDetailsState.maybeWhen(
                orElse: () => false,
              ...
              onHeartTap: () {
                ...
                ref.read(orderDetailsProvider(id).notifier).toogleFavorite();
                if (listInitialParams != null) {
                  ref
                      .read(
                          orderListProvider(params: listInitialParams).notifier)
                      .toogleFavorite(id);
                }
              },
            ),
            orderDetailsState.when(
              data: (data) => Column(
                children: [
                  Gap(27),
        ...
        floatingActionButton: orderDetailsState.maybeWhen(
          orElse: () => null,
          data: (data) {
            ...
            return Padding(
              ...
              child: EditAdButtonScreen(
                onTap: () async {
                  showAddOrderSheet(context, id: id);
                },
                height: 49,
                borderRadius: 15,
                titleFontSize: 14,
