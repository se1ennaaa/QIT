...
enum MarketType {
  ...
  bool get isMadina => this == madina;
  bool get isDordoi => this == dordoi;
}

class MarketSelectionSheet extends HookWidget {
  const MarketSelectionSheet(
  ...
  final Function(MarketType type) onMarketSelected;
              ...
              GestureDetector(
                ...
                onTapUp: (details) {
                  ...
                  if (position.dx >= 0 &&
                    ...
                    onMarketSelected.call(MarketType.dordoi);
                  }
                },
              ...
              GestureDetector(
                ...
                onTapUp: (details) {
                  ...
                  if (position.dx >= 0 &&
                      ...
                      position.dx <= renderBox.size.width &&
                      position.dy <= renderBox.size.height) {
                    onMarketSelected.call(MarketType.madina);
                  }
                },
