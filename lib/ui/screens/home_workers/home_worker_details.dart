...
class HomeWorkerDetailsScreen extends HookConsumerWidget {
  const HomeWorkerDetailsScreen(
    this.id, {
    super.key,
  ...
  final int id;
  final HomeWorkerParamsModel? listInitialParams;
  final bool canEdit;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final resumeDetailsState = ref.watch(homeWorkerDetailsProvider(id));
      ...
      child: Scaffold(
        body: ListView(
          ...
          children: [
            CustomAppBar(
              title: 'Надомник',
              isFavorite: resumeDetailsState.maybeWhen(
                orElse: () => false,
              ...
              onHeartTap: () {
                ...
                ref.read(toggleFavoriteProvider(id, FavoriteType.nadom));
                ref
                    .read(homeWorkerDetailsProvider(id).notifier)
                    .toogleFavorite();
                if (listInitialParams != null) {
                  ref
                      .read(homeWorkerListProvider(params: listInitialParams)
                          .notifier)
                      .toogleFavorite(id);
                }
              },
            ),
            resumeDetailsState.when(
              data: (data) => Column(
                children: [
                  Gap(24),
                  Padding(
        ...
        floatingActionButton: resumeDetailsState.maybeWhen(
          orElse: () => null,
          data: (data) {
            ...
            return Padding(
              ...
              child: EditAdButtonScreen(
                onTap: () async {
                  showAddResumeSheet(context, id: id);
                },
                height: 49,
                borderRadius: 15,
                titleFontSize: 14,
