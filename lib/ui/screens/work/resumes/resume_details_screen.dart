...
class ResumeDetailsScreen extends HookConsumerWidget {
  ...
  final int id;
  final ResumeParamsModel? listInitialParams;
  final bool canEdit;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final resumeDetailsState = ref.watch(resumeDetailsProvider(id));
          ...
          children: [
            CustomAppBar(
              ...
              onHeartTap: () {
                ...
                ref.read(resumeDetailsProvider(id).notifier).toogleFavorite();
                if (listInitialParams != null) {
                  ref
                      .read(resumeListProvider(params: listInitialParams)
                          .notifier)
                      .toogleFavorite(id);
                }
              },
