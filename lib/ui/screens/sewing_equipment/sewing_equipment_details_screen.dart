...
class SewingEquipmentSaleDetailsScreen extends HookConsumerWidget {
  const SewingEquipmentSaleDetailsScreen(
    this.id, {
    super.key,
  ...
  final int id;
  final SewingEquipmentParamsModel? listInitialParams;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final sewingEquipmentSaleDetailsState =
        ref.watch(sewingEquipmentDetailsProvider(id));
      ...
      child: Scaffold(
        body: ListView(
          ...
          children: [
            CustomAppBar(
              title: 'Продажа',
              isFavorite: sewingEquipmentSaleDetailsState.maybeWhen(
                orElse: () => false,
              ...
              onHeartTap: () {
                ...
                ref.read(toggleFavoriteProvider(id, FavoriteType.apparel));
                ref
                    .read(sewingEquipmentDetailsProvider(id).notifier)
                    .toogleFavorite();
                print(listInitialParams != null);
                if (listInitialParams != null) {
                  ref
                      .read(
                          sewingEquipmentListProvider(params: listInitialParams)
                              .notifier)
                      .toogleFavorite(id);
                }
              },
            ),
            sewingEquipmentSaleDetailsState.when(
              data: (data) => Column(
                children: [
                  Gap(27),
        ...
        floatingActionButton: sewingEquipmentSaleDetailsState.maybeWhen(
          orElse: () => null,
          data: (data) {
            ...
            return Padding(
              ...
              child: EditAdButtonScreen(
                onTap: () async {
                  addSewingEquipmentSheet(context, id: id);
                },
                height: 49,
                borderRadius: 15,
                titleFontSize: 14,
