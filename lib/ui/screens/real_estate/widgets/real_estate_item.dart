...
class RealEstateItem extends HookWidget {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Gap(5),
              Text(
                model.price?.toString() ?? 'договорная',
                style: TextStyle(
          ...
          if (model.area != null) ...[
            Row(
              children: [
                SvgPicture.asset('assets/svg/bx_area.svg'),
                Gap(5),
                Text(
                  model.area!,
          ...
          if (model.status != null && canEdit) ...[
            ...
            EditAdButtonScreen(
              onTap: () {
                showAddRealEstateSheet(context, id: model.id);
              },
            ),
          ],
        ],
