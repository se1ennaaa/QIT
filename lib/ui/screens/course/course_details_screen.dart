...
class CourseDetailsScreen extends HookConsumerWidget {
  ...
  final int id;
  final CourseParamsModel? listInitialParams;
  final bool canEdit;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final courseDetailsState = ref.watch(courseDetailsProvider(id));
      ...
      child: Scaffold(
        body: ListView(
          ...
          children: [
            CustomAppBar(
              title: 'Заказы',
              isFavorite: courseDetailsState.maybeWhen(
                orElse: () => false,
              ...
              onHeartTap: () {
                ...
                ref.read(toggleFavoriteProvider(id, FavoriteType.teaching));
                ref.read(courseDetailsProvider(id).notifier).toogleFavorite();
                if (listInitialParams != null) {
                  ref
                      .read(courseListProvider(params: listInitialParams)
                          .notifier)
                      .toogleFavorite(id);
                }
              },
            ),
            courseDetailsState.when(
              data: (data) => Column(
                children: [
                  Gap(27),
        ...
        floatingActionButton: courseDetailsState.maybeWhen(
          orElse: () => null,
          data: (data) {
            ...
            return Padding(
              ...
              child: EditAdButtonScreen(
                onTap: () async {
                  showAddCourseSheet(context, id: id);
                },
                height: 49,
                borderRadius: 15,
                titleFontSize: 14,
