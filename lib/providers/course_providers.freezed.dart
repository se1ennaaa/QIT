...
mixin _$CourseListState {
  AsyncValue<List<CourseModel>> get list => throw _privateConstructorUsedError;
  CourseParamsModel get params => throw _privateConstructorUsedError;
...
abstract class $CourseListStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {AsyncValue<List<CourseModel>> list,
      CourseParamsModel params,
      bool isPageNotFound});

  $CourseParamsModelCopyWith<$Res> get params;
}
...
class _$CourseListStateCopyWithImpl<$Res, $Val extends CourseListState>
    ...
    return _then(_value.copyWith(
      list: null == list
          ...
          : list // ignore: cast_nullable_to_non_nullable
              as AsyncValue<List<CourseModel>>,
      params: null == params
          ? _value.params
          : params // ignore: cast_nullable_to_non_nullable
              as CourseParamsModel,
  ...
  @pragma('vm:prefer-inline')
  $CourseParamsModelCopyWith<$Res> get params {
    return $CourseParamsModelCopyWith<$Res>(_value.params, (value) {
...
class _$CourseListStateImpl implements _CourseListState {
  const _$CourseListStateImpl(
      ...
      this.params = const CourseParamsModel(),
      this.isPageNotFound = false});

  @override
  @JsonKey()
  final AsyncValue<List<CourseModel>> list;
  @override
  @JsonKey()
  ...
  @override
  String toString() {
    return 'CourseListState(list: $list, params: $params, isPageNotFound: $isPageNotFound)';
  }
...
abstract class _CourseListState implements CourseListState {
  const factory _CourseListState(
      {final AsyncValue<List<CourseModel>> list,
      final CourseParamsModel params,
      final bool isPageNotFound}) = _$CourseListStateImpl;

  @override
  AsyncValue<List<CourseModel>> get list;
  @override
